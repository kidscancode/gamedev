...
pew_sound = pygame.mixer.Sound(sound_dir + 'pew.wav')
shield_sound = pygame.mixer.Sound(sound_dir + 'pow4.wav')
power_sound = pygame.mixer.Sound(sound_dir + 'pow5.wav')
player_die_sound = pygame.mixer.Sound(sound_dir + 'rumble1.ogg')
expl_sounds = []
for snd in ['expl3.wav', 'expl6.wav']:
    expl_sounds.append(pygame.mixer.Sound(sound_dir + snd))
pygame.mixer.music.load(sound_dir + 'tgfcoder-FrozenJam-SeamlessLoop.ogg')
pygame.mixer.music.set_volume(0.4)
background = pygame.image.load(img_dir + 'starfield.png').convert()
background_rect = background.get_rect()
player_image = pygame.image.load(img_dir + 'playerShip1_orange.png').convert()
player_image.set_colorkey(BLACK)
player_mini_image = pygame.transform.scale(player_image, (25, 19))
bullet_image = pygame.image.load(img_dir + 'laserRed16.png').convert()
...
powerup_images = {}
powerup_images['shield'] = pygame.image.load(img_dir + 'shield_gold.png').convert()
powerup_images['gun'] = pygame.image.load(img_dir + 'bolt_gold.png').convert()
explosion_anim = {}
explosion_anim['lg'] = []
explosion_anim['sm'] = []
explosion_anim['player'] = []
for i in range(9):
    img = pygame.image.load(img_dir + 'regularExplosion0{}.png'.format(i)).convert()
    ...
    img = pygame.image.load(img_dir + 'sonicExplosion0{}.png'.format(i)).convert()
    img.set_colorkey(BLACK)
